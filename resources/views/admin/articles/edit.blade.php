        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-3">
                            <form id="new-article" action="{{ route('articles.update', $article->id) }}" method="post"
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" required>{!! $article->description !!}</textarea>
