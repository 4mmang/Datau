        ...
        <div id="content">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item active" href="{{ route('profileAdmin') }}">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-center mb-4">
                    <p class="fs-2 mb-0 text-center" style="color: #38527E">My Profile</p>
                </div>
                ...
                <div class="row justify-content-center mt-3">
                    <div class="col-md-6">
                        <div class="card p-3 shadow-sm">
                            ...
                            @endif
                            <form action="{{ url('reset-password') }}" id="form-reset-password" method="POST"
                                class="mt-3">
                                @csrf
                                ...
                                <button type="submit" id="btn-reset-password"
                                    class="btn form-control mt-4 text-white mb-3"
