        ...
        <main id="basic-info">
            <div class="container login-container p-3" style="margin-top: 10rem; margin-bottom: 3rem">
                ...
                <form>
                    ...
                    <div class="row justify-content-center mt-3">
                        <div class="col-md-8">
                            <a href="#" id="btnNext" onclick="next()" class="btn fs-6 text-light mt-2"
        ...
        <main id="more-info" style="display: none">
            <div class="container" style="margin-top: 6rem; margin-bottom: 3rem">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-md-8">
                        <a href="#" class="btn btn-secondary fs-6" onclick="previous()" id="previous"><i
                                class="fas fa-angle-double-left"></i> Sebelumnya</a>
                        <button id="submit" onclick="submit()" type="button" class="btn fs-6 text-light"
                            style="background-color: #38527E"><i class="fas fa-save ms-1"></i> Simpan</button>
                    </div>
                </div>
            </div>
        </main>
